...
@Slf4j
@SpringBootTest
public class MemberServiceV6Test {
    ...
    @Autowired
    private MemberServiceV6 memberService;
    ...
    static class TestConfig {
        ...
        @Bean
        MemberServiceV6 memberServiceV6() {
            return new MemberServiceV6(memberRepository());
        }
    }
